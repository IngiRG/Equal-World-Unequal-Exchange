...
def main():
    ...
    for iso3,g in out.groupby("iso3"):
        ...
        gap=equal-actual
        payload={
          "iso3":iso3,"country":r["country"],"status":"DEMONSTRATION — NOT AN EMPIRICAL ESTIMATE",
          "steps":[
    ...
    manifest={"model_version":"0.1.0","generated_utc":datetime.now(timezone.utc).isoformat(),
      "data_status":"synthetic demonstration","source":"data/demo/country_sector.csv",
